...
export default function FloatingWhatsApp() {
  return (
    ...
    >
      <a
        href={`https://wa.me/${BRAND.whatsapp}?text=Hi%2C%20I%20am%20interested%20in%20CODENAME%20HI%20FIVE%20at%20ORR%20Exit-5.`}
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Chat with Sales on WhatsApp"
        className="w-14 h-14 rounded-full shadow-2xl flex items-center justify-center hover:scale-110 active:scale-95 transition-all group relative"
      >
        <WhatsAppIcon className="w-14 h-14 drop-shadow-xl" size={56} />
