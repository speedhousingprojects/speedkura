  ...
  return (
    <div className={`inline-flex flex-col items-center select-none ${className}`}>
      ...
      <div className="flex items-center justify-center gap-3 sm:gap-5 mb-2 sm:mb-3 w-full min-w-[260px] sm:min-w-[340px] md:min-w-[420px]">
        <span className="flex-1 max-w-[120px] sm:max-w-[160px] h-[2px] bg-[#CE793A] rounded-full" />
        <span className="font-gumani text-xs sm:text-sm md:text-base lg:text-lg font-bold tracking-[0.3em] uppercase text-[#F5F3E6] whitespace-nowrap">
          CODENAME
        </span>
        <span className="flex-1 max-w-[120px] sm:max-w-[160px] h-[2px] bg-[#CE793A] rounded-full" />
      </div>
